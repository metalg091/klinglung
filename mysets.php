    ...
    <div class="container-fluid mx-3">
        ...
        <div class="collapse navbar-collapse" id="navbarNav">
            <ul class="navbar-nav me-auto">
                ...
                <li class="nav-item" id="mset">
                    <a class="nav-link active" href="#">My sets</a>
                </li>
            </ul>
            <div class="d-flex">
                <button type="button" class="btn btn-info" id ="navbtn" onclick="location.href='newlist.php';">Create New</button>
            </div>
        </div>
    </div>
</nav>
...
<script>
    <?php
        ...
        include "dbconn.php";
        $creator = mysqli_real_escape_string($conn, $_SESSION["name"]);
        $sql = "SELECT * FROM info WHERE creator = '" . $_SESSION["name"] . "'";
